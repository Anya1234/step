...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void onlyMandatoryConsideredIfOptionalAreBusy() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  public void justOptionalWholeDayFreeAttendees() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Optional:       |--A--|     |--B--|
  ...
  public void OptionalEventInterferesWithNonOptional() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Optional:               |------C--------|
  ...
  public void OptionalEventInterferesWithBothNonOptionals() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Optional:          |----C------|
